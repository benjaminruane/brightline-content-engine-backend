...
**Recommended order:** ~~commentary calibration~~ (**SHIPPED** `commentary-calibration`) → ~~editorial rule bug-fix pass~~ (**SHIPPED** R6.2e + R6.2f) → ~~editorial schema-fallback~~ (**SHIPPED** R6.11a + R6.11b + **B21**) → ~~**R6.6 (source-public-state)**~~ (**SHIPPED 2026-06-25**) → **constructive feedback output** → R7. Front-loads cheap, broad, low-risk wins; defers feature-sized work.
