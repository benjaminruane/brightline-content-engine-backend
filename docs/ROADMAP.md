...
Last updated: 2026-06-03 (R6.2e/R6.2f + R6.11a/b shipped; B21/B23 closed; internal_plausibility watch logged)
...
**Recommended order:** ~~commentary calibration~~ (**SHIPPED** `commentary-calibration`) → ~~editorial rule bug-fix pass~~ (**SHIPPED** R6.2e + R6.2f) → ~~editorial schema-fallback~~ (**SHIPPED** R6.11a + R6.11b) → then R6.6 / source-public-state / R7. Front-loads cheap, broad, low-risk wins; defers feature-sized work.
...
3. ~~**COMMENTARY CALIBRATION**~~ — **SHIPPED 2026-06-03** (`commentary-calibration`). ~~**EDITORIAL RULE BUG-FIX PASS**~~ — **SHIPPED 2026-06-03** (R6.2e + R6.2f). Next: **SOURCE-PUBLIC-STATE AWARENESS** / **R6.6** — see **Near-term — Review output**.
