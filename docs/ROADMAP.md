...
**Recommended order:** ~~commentary calibration~~ (**SHIPPED** `commentary-calibration`) → ~~editorial rule bug-fix pass~~ (**SHIPPED** R6.2e + R6.2f) → ~~editorial schema-fallback~~ (**SHIPPED** R6.11a + R6.11b) → ~~**R6.6 (source-public-state)**~~ (**SHIPPED 2026-06-25**) → **constructive feedback output** → R7. Front-loads cheap, broad, low-risk wins; defers feature-sized work.
...
3. ~~**COMMENTARY CALIBRATION**~~ — **SHIPPED 2026-06-03** (`commentary-calibration`). ~~**EDITORIAL RULE BUG-FIX PASS**~~ — **SHIPPED 2026-06-03** (R6.2e + R6.2f). ~~**R6.6 (source-public-state)**~~ — **SHIPPED 2026-06-25**. Next: **CONSTRUCTIVE FEEDBACK OUTPUT** — see **Near-term — Review output**.
...
11. **Document-type appropriateness (R6.12)** — Medium; expanded for document-type-aware voice/register (2026-06-01). ~~**Source-public-state awareness (R6.6)**~~ — **SHIPPED 2026-06-25** (see Recently shipped → R6.6). **Forward-looking statement review (R6.7)** — Medium. **Cross-source display semantics (R6.8)** — Medium. **Non-claim statement handling (R6.9)** — shipped; residual functional-element noise confirmed 2026-06-01. **Source quality audit (R6.10)** — Low.
