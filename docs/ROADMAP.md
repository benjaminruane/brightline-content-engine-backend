...
Last updated: 2026-08-29 (Revise arc closed; silence never edits; corpus re-baselined; ROADMAP/BACKLOG reconciliation)
...
**Open from this arc:** **B122** directive follow rate, about 7 in 10, cause unknown and call-splitting ruled out — the largest remaining quality gap in Suggest. **B123** F02:S6 anchor tokenisation, a live false red on the client's own statements. **B98** revision-layer instability, now quantified at 8 of 10 cards varying across three runs on one unchanged Review, and confirmed as generated in the revision layer rather than inherited from Review. New hygiene: **B124**-**B126**, **P29**, **P30**. New capability gaps: **Pr16** internal consistency in Review (Ben, must-have), **Pr17** accept and reject per change.
