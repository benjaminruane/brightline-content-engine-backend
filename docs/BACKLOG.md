...
| B26 | **ACTIVE** — Constructive Feedback output. On-demand generate in Reviewer Assessment panel (`api/constructive-feedback.js`). Locked decisions: ROADMAP **Active sprint — B26**. **Resolves Pr8** and ROADMAP **#19** (Reviewer Assessment not reframed). Sibling to Reviewer Assessment; no revised text; plain-text Copy; signal order Evidence → Compliance → Editorial; no role-based branching. **Watch:** signoff duplication — see subsection below. | Reviewer Copilot-assisted feedback workflow, 2026-06 | M | MVP | Cross-ref **Pr8** (resolved → Closed); watch → ROADMAP **B26 — Signoff logic duplication** |
...
| Pr8 | **RESOLVED (B26, 2026-06-30)** — Reviewer Assessment reframe. Closed by **not** reframing Reviewer Assessment: **B26** takes detailed author-facing constructive feedback; Reviewer Assessment (`api/synthesize-review.js`) unchanged as short reviewer-facing overview. ROADMAP open list **#19**. | **B26** |
