...
- sources: one object per source, in source order, each with classification (same four labels) and passage (verbatim quote from that source; empty if you did not rely on it)
