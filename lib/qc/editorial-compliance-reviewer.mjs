...
const FIRST_PERSON_ACTOR_PROMPT_BLOCK = `FIRST-PERSON REMOVAL (applies equally to first_person_plural and voice_consistency)
${FIRST_PERSON_ACTOR_INSTRUCTION}`;
...
${formatAuthoringOrganisationPromptBlock(draftMarked)}
...
${formatAuthoringOrganisationPromptBlock(draftText)}
...
${FIRST_PERSON_ACTOR_PROMPT_BLOCK}
...
export async function runEditorialStyleReview(args) {
  ...
  const sorted = sortConcernsBySeverity(noOpFiltered, mergedMap, outputSlug);
