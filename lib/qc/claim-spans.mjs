...
// AUTHOR-NAME-BLIND: this regex collects VERIFIABLE ANCHORS — the things in a
// sentence a source could corroborate. It is not asking who is an outside
// party. The authoring organisation's own name is legitimately checkable, and
// excluding it would shrink the anchor set for no gain. Adjudicated b55ab00.
