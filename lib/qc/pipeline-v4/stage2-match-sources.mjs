...
// Prompt and validation logic are copied verbatim from production v3:
//   lib/qc/pipeline-v3/stage2-match-sources.mjs
// Keep this file in sync when the v3 Stage 2 prompt or normalization changes.
...
// Verbatim copy of v3 STAGE2_SYSTEM_PROMPT (lib/qc/pipeline-v3/stage2-match-sources.mjs).
