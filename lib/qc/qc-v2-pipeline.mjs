...
export function runQcV2Pipeline(statements, context) {
  ...
  for (let idx = 0; idx < (statements || []).length; idx++) {
    ...
    // TEMP A6.50h debug: remove after browser QC investigation
    console.log("[A6.50h][QC_V2_STMT_DEBUG]", JSON.stringify({
      statementIndex: idx,
      dealTermsCanonical: stmt.__dealTermsCanonical === true,
