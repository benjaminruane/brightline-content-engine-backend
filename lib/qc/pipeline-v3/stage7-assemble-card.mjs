...
function safeEditorialDefaults(assemblyContext = {}) {
  const editorialOn = reviewEnabled(assemblyContext, "editorialEnabled") === true;
  const complianceOn = reviewEnabled(assemblyContext, "complianceEnabled") === true;
  return {
    editorialVerdict: editorialOn ? "not_reviewed" : "clean",
    editorialConcerns: [],
    editorialNote: null,
    editorialSuggestedDirection: null,
    editorialSuggestedRewrite: null,
    complianceVerdict: complianceOn ? "not_reviewed" : "clean",
    complianceConcerns: [],
    complianceNote: null,
