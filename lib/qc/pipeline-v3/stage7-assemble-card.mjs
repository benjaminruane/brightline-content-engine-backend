...
function resolveAssembledVerdict(raw, enabled) {
  ...
  if (enabled === false) return "not_reviewed";
  if (enabled === true) {
...
function safeEditorialDefaults(assemblyContext = {}) {
  const editorialOn = reviewEnabled(assemblyContext, "editorialEnabled");
  const complianceOn = reviewEnabled(assemblyContext, "complianceEnabled");
  return {
    editorialVerdict: editorialOn === null ? "clean" : "not_reviewed",
    editorialConcerns: [],
    editorialNote: null,
    editorialSuggestedDirection: null,
    editorialSuggestedRewrite: null,
    complianceVerdict: complianceOn === null ? "clean" : "not_reviewed",
    complianceConcerns: [],
    complianceNote: null,
