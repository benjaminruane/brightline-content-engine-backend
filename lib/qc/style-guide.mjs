...
export const STYLE_GUIDE_LAYER_2_CLIENT = [
  ...
  },
  {
    id: "number_spelling",
    description:
      "Spell out numbers 0–12; use numerals for 13 and above. Carve-outs: percentages, currency amounts, dates, ages, and units of measurement always use numerals. Do not flag percent vs % notation — use percentage_notation for that.",
  ...
  },
  {
    ...
    description:
      "Percentages use the '%' symbol, not the word 'percent' (e.g. '5.4%', not '5.4 percent'). When raising a concern, quote the exact 'percent' wording from the statement; do not cite the corrected '%' form.",
    correct_example: "Net initial yield is 5.4%.",
    incorrect_example: "Net initial yield is 5.4 percent.",
    applies_to: ["*"],
    layer: 2,
    client: "CLIENT",
  },
