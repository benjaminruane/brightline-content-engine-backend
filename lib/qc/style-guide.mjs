...
export const STYLE_GUIDE_LAYER_1 = [
  {
    ...
    description:
      "Defined terms (the Company, the Fund, the Investment, etc.) are capitalised when used as the defined term.",
    correct_example: "The Company reported revenue growth in the quarter.",
    incorrect_example: "The company reported revenue growth in the quarter.",
    applies_to: ["*"],
    layer: 1,
  },
  {
