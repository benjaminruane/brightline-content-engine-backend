...
export const STYLE_GUIDE_LAYER_2_CLIENT = [
  ...
  },
  {
    ...
    description:
      ...
      FIRST_PERSON_ACTOR_INSTRUCTION,
    correct_example:
      `${HOUSE} completed the investment in Q2. ${HOUSE} was attracted to Meridian. ${HOUSE} believes the fund should deliver returns broadly in line with its predecessor and ${HOUSE} recommends the commitment. Access that would not otherwise have been available to ${HOUSE}.`,
    incorrect_example:
