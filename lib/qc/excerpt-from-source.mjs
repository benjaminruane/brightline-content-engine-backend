...
// AUTHOR-NAME-BLIND: the figures guard requires every multi-word Title-Case
// phrase in the pointer to survive into the source slice. The authoring
// organisation is one more such phrase. Dropping it would be a miss, so it
// is treated like any other name here.
