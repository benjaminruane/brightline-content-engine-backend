...
export function getPromptGuidance(outputType, visibility) {
  ...
  if (ot === "INVESTOR_LETTER") {
    parts.push("Format as an investor letter: direct address, clear narrative, professional tone.");
  } else if (ot === "PRESS_RELEASE") {
    parts.push("Format as a press release: headline-ready, factual, third-person, concise paragraphs.");
  } else if (ot === "LINKEDIN_POST") {
    parts.push("Format as a LinkedIn post: concise, engaging, suitable for social sharing.");
  } else {
