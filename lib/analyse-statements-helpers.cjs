...
// A3.9.22: Local normalizeNumber — self-contained, no external deps; never throws.
// Accepts number|string|null|undefined; returns canonical numeric string for matching/dedup.
