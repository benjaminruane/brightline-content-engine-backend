...
// AUTHOR-NAME-BLIND: this feeds checkNoSpanEntitiesKept, which rejects an edit
// that DELETES a name. Losing who acted is a defect whether the actor is the
// client or a third party, so the author must be protected here exactly like
// anyone else. PROPER_NOUN_RE above is the opposite case and IS author-aware:
// checkNoInventedFacts takes the authoring organisation so the client's own
// name is never called an invention. Adjudicated b55ab00.
