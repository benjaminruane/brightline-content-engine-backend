...
export async function fillAction(entry, { authoringOrganisation, callModel, draftText, candidateProposal } = {}) {
  if (
  ...
  if (isContradictedEvidenceFinding(entry)) {
    const outcome = applyConflictProposal(entry, candidateProposal || null);
