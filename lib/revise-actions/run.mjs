...
function asVisibleAcknowledge(entry) {
  return {
    ...entry,
    disposition: "ACKNOWLEDGE",
    noProposalReason: NO_PROPOSAL.visible_signal,
    sort: {
      ...entry.sort,
      policyPermit: false,
      reasonCode: "visible_signal",
    },
  };
}
...
export async function fillAction(entry, { authoringOrganisation, callModel }) {
  if (
