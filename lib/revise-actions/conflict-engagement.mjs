...
/**
 * Candidate pairs: same kind, different value, source token asserted as the
 * current/correct figure. A draft token that appears only as the negated or
 * superseded figure in the excerpt is the signal that the pair is real, not a
 * disqualifier. A draft token with no same-kind counterpart is ignored.
 */
