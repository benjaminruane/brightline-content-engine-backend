...
/** @typedef {"published_external"|"internal_or_draft"|"unknown"} PublicationState */

/** @type {ReadonlySet<string>} */
const VALID_PUBLICATION_STATES = new Set(["published_external", "internal_or_draft", "unknown"]);
