 ...
 * char-normalize (offsets remapped) → declared-intent honesty check.
...
export function finalizeSuggestRevisionText(rawLlmText, opts = {}) {
  ...
  if (!originalDraft) {
    return { ...normalised, honestyEvents: [] };
  }
  return applyMarkerHonestyCheck(originalDraft, normalised, {
...
- Example (soften / marketing): {{solid growth across every segment||CHANGED: Softened 'excited to announce incredible growth' to a neutral description — it read as promotional. Confirm before publishing.}}
