// lib/analyse-statements-helpers.mjs
// A3.8.185: Extracted helper functions from analyse-statements-impl.mjs
// These functions are exported as named exports for explicit import in impl file

// A3.8.186: Module load marker
console.log("[DIAG][A3.8.186][HELPERS_LOADED]");

// Import utilities from impl (circular dependency is handled by ESM)
import {
  diag,
  corpusSearch,
  classifyStatementAndProvenance,
  isAnchorFact,
  isUncertaintyReason,
  extractAnchorFacts,
  hasAbsenceClaim,
  validateCompoundNumericAnchors,
  decomposeAndValidateCompoundAnchors,
  parseReason,
  formatReason,
...
// Export all 9 functions as named exports
export {
...
// A3.8.187: Marker export to confirm file parsed successfully
export const __A3_8_187_HELPERS_OK = true;
