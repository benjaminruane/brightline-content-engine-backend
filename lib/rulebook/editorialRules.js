...
import { houseVoiceEditorialProse } from "../prompt-library/house-voice.mjs";
import {
  EVALUATIVE_LANGUAGE_FIX_DIRECTION,
  EVALUATIVE_LANGUAGE_INSTRUCTION,
} from "../qc/evaluative-language.mjs";
...
export default [
  {
    ...
    description:
      "The voice appropriate for the output type is maintained throughout. " +
      houseVoiceEditorialProse() +
      " On LinkedIn the first-person plural represents the firm, not the individual author. Flag unintended switches in voice within the document. " +
      FIRST_PERSON_ACTOR_INSTRUCTION,
    appliesTo: [...ALL],
  ...
  },
  {
    ...
    description:
      "Causal claims ('driven by', 'as a result of', 'because of', 'thanks to') asserted where the draft itself does not establish the causal link. Correlation stated as causation. Strong claims of influence the draft does not warrant. Judge this from the CURRENT STATEMENT and the surrounding draft only. Whether a source supports the claim is an Evidence matter and is not assessed here. Do not use the words evidence, source, supported, unsupported or substantiated in the note or the direction. You cannot see the source documents. Describe only what the CURRENT STATEMENT and the surrounding draft do or do not establish.",
    appliesTo: [...ALL],
    appliesToVersion: null,
  },
  {
    ...
    severity: "soft_concern",
    description:
      "Stacked or redundant hedging that weakens a statement without adding precision: 'seems to suggest', 'may possibly indicate', 'could be interpreted as', 'appears to potentially', where two or more hedges do the work of one. Judge this from the CURRENT STATEMENT and the surrounding draft only. Whether a source makes the position clear is an Evidence matter and is not assessed here. Do not use the words evidence, source, supported, unsupported or substantiated in the note or the direction. You cannot see the source documents. Describe only what the CURRENT STATEMENT and the surrounding draft do or do not establish.",
    appliesTo: [...THREE],
    appliesToVersion: null,
  },
  {
  ...
  },
  {
    ...
    description:
      "Flag explicit hyperbole and distinction-claim language that asserts exceptionality. Words and phrases in this class include: 'exceptional', 'exceptionally', 'unparalleled', 'extraordinary', 'unmatched', 'world-class', 'industry-leading', 'market-leading', 'best-in-class', 'revolutionary', 'game-changing', 'transformative', 'genuinely [adjective]', 'genuine differentiator'. " +
      EVALUATIVE_LANGUAGE_INSTRUCTION,
    appliesTo: [...ALL],
    appliesToVersion: null,
