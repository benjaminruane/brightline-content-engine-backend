...
export default [
  {
    ...
    description:
      "The voice appropriate for the output type is maintained throughout. Reporting commentary uses third-person. Investor letters, press releases, and LinkedIn posts use first-person plural (we, our). On LinkedIn the first-person plural represents the firm, not the individual author. Flag unintended switches in voice within the document. " +
      FIRST_PERSON_ACTOR_INSTRUCTION,
    appliesTo: [...ALL],
