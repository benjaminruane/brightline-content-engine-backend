...
export default [
  ...
  },
  {
    ...
    severity: "soft_concern",
    description:
      "Vague qualifiers (nearly, roughly, approximately, around, some, several) are acceptable when the underlying figure is genuinely approximate (forecasts, estimates, ranges). They are flagged when a precise figure is available in the source or context. 'Nearly 10,000 customers' is flagged if the exact figure '9,842' is known.",
    appliesTo: [...THREE],
    appliesToVersion: null,
    fixDirection:
      "Quote the vague phrase from the CURRENT STATEMENT and the more precise figure or wording from the EVIDENCE EXCERPT in your suggestedDirection.",
  },
  {
