...
export default [
  ...
  },
  {
    ...
    severity: "hard_concern",
    description:
      "Language that is typically restricted or prohibited under fund marketing regulations. Unqualified superlatives applied to fund performance ('the best fund', 'top-performing'), absolute claims of market position without substantiation, or promissory phrasing beyond C1.",
    appliesTo: [...ALL],
    appliesToVersion: null,
  },
  {
