...
export default [
  ...
  },
  {
    ...
    severity: "hard_concern",
    description:
      "Forward-looking statements (projections, forecasts, expectations, 'will', 'expects to', 'projected to', 'anticipates') without an uncertainty qualifier ('may', 'could', 'expect', 'expects', 'expected', 'aim', 'believe', 'subject to market conditions') or a disclaimer nearby. Do NOT flag when the statement already contains adequate hedging: 'we expect', 'expect', 'expects', or 'expected' satisfy this rule on Complete and Public visibility.",
    appliesTo: [...ALL],
    appliesToVersion: null,
  },
  {
  ...
  },
  {
    ...
    severity: "hard_concern",
    description:
      "Language that is typically restricted or prohibited under fund marketing regulations. This rule applies to claims about the fund or the firm itself — fund performance superlatives ('the best fund', 'top-performing'), firm-level absolute claims of market position without substantiation, promissory phrasing beyond C1 — and to language that solicits investment in the fund or links portfolio performance to a fund marketing pitch. This rule does NOT apply to ordinary descriptive language about portfolio companies in transaction releases (acquisition, exit, investment announcements) or in operational updates, including superlatives describing the portfolio company's market position, products, or growth trajectory ('exceptionally well positioned', 'leading provider', 'best-in-class technology'). Fund marketing regulations vary by jurisdiction (SEC, FCA, MAS, BaFin etc.); the reviewer flags potentially restricted language as a review prompt, not a determination.",
    appliesTo: [...ALL],
    appliesToVersion: null,
    reviewerNote:
      "Frame as review prompt, not a determination. Confirm the language is reviewed against the applicable jurisdiction's fund marketing rules. Example: 'This sentence makes a fund-level performance claim in a public investor letter. Confirm the phrasing meets the applicable jurisdiction's fund marketing rules.'",
  },
  {
  ...
  },
  {
    ...
    description:
      "Comparative or superlative claims ('outperforms peers', 'larger than competitors', 'fastest-growing', 'leading', 'largest in [entity]'s history') without a named benchmark, supporting figure, time period, or source in the same sentence or immediate context. Substantiation present = do not flag: when the same sentence (or immediate context) includes the supporting figure or named benchmark that grounds the claim, omit this rule. Example that must NOT fire: 'Fund V is the largest fund in Meridian's history, at EUR 3.2 billion versus EUR 2.1 billion for Fund IV' — the basis is present. A bare 'largest in Meridian's history' with no figure or benchmark nearby still fires.",
    appliesTo: [...ALL],
    appliesToVersion: null,
  },
];
