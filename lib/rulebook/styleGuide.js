...
// A8.22: Style-guide rulebook (ported from helpers/styleGuides.js + editorial house-style scope).

/** Full institutional style reference — same text as legacy helpers/styleGuides.js */
...
const CURRENCY_RULE_TEXT = `CURRENCIES
- When the source uses bare currency symbols ($, €, £) without codes, rewrite them into the proper currency code plus amount where the currency is clear:
  - $10 million → USD 10 million
  - €250’000 → EUR 250’000
  - £5’500 → GBP 5’500
...
const THOUSANDS_RULE_TEXT = `- Use the apostrophe (’) as the thousands separator:
  - 12’500
  - 5’500’000
- Do not use commas as thousands separators.`;

/** House-style reference excluding currency notation and thousands-separator bullets (separate rules above). */
const HOUSE_STYLE_REFERENCE_BODY = `
TONE & AUDIENCE
- Write in a neutral, professional, institution-grade tone.
- Assume a financially literate audience (investment professionals, client relationship teams, sophisticated investors).
- Avoid marketing hype and exaggeration. Prefer measured, evidence-based language.
...
/** HOUSE STYLE dimension from legacy editorial prompt, plus reference text (excluding currency and thousands rules, which are separate entries). */
const HOUSE_STYLE_RULE_TEXT = `HOUSE STYLE
...
export default [
  {
    ...
    description: CURRENCY_RULE_TEXT,
  ...
  },
  {
    ...
    category: "style_guide",
    severity: "soft_concern",
    description: `Thousands separators (from NUMBERS & UNITS):\n${THOUSANDS_RULE_TEXT}`,
    appliesTo: [...ALL_OUTPUTS],
    appliesToVersion: null,
  },
  {
    ...
    category: "style_guide",
    severity: "soft_concern",
    description: HOUSE_STYLE_RULE_TEXT,
    appliesTo: [...ALL_OUTPUTS],
    appliesToVersion: null,
  },
];
