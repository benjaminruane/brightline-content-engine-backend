...
describe("constructive-feedback", () => {
  ...
  test("normalizeConstructiveFeedbackPlainText strips markdown", () => {
  ...
  test("split and assemble card feedback sections", () => {
  ...
  test("strip craft preamble and renumber point blocks", () => {
    assert.equal(
      stripCraftPreamble(
  ...
  test("assemble craft and card feedback with renumbering", () => {
  ...
  test("B26.2.4 craft output-type fallback coverage", () => {
